...
#ifndef _LIBIODEF_LIBIODEF_ERROR_HXX
#define _LIBIODEF_LIBIODEF_ERROR_HXX

#include <string>
#include <exception>

#define libiodef_except_if_fail(cond) do {                                   \
        if ( ! (cond) )                                                     \
                throw LibIodefError(libiodef_error(LIBIODEF_ERROR_ASSERTION)); \
} while(0)
