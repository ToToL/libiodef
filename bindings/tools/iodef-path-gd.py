...
#        value = iodef.Get("alert.classification.ident")
#        if value:
#               print value

#        value = iodef.Get("alert.source(0).ident")
#        if value:
#               print value
...
#        value = iodef.Get("alert.classification.reference(0).origin")
#        if value:
#               print value

#        value = iodef.Get("alert.classification.reference(0).name")
#        if value:
#               print value
