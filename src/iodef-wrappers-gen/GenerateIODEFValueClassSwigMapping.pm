...
package GenerateIODEFValueClassSwigMapping;
...
/* Auto-generated by the GenerateIODEFValueClassSwigMapping package */
...
void *swig_iodef_value_get_descriptor(iodef_value_t *value)
{
        unsigned int i = 0;
        iodef_class_id_t wanted_class = iodef_value_get_class(value);
	const struct {
...
");
    ...
    foreach my $obj ( sort { $a->{id} <=> $b->{id} } map { 
       ...
       if ( $obj->{obj_type} == &OBJ_STRUCT ) { 
           $object_class = "IODEF_CLASS_ID_" . uc("$obj->{short_typename}");
