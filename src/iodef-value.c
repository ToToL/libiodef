...
iodef_value_decl(STRING, string, prelude_string_t *)
...
static int iodef_value_set_own_data(iodef_value_t *value, prelude_bool_t own_data)
{
        int cnt;
...
static int cast_to_data(iodef_value_t *input)
{
        ...
        if ( vtype == IODEF_VALUE_TYPE_STRING ) {
                prelude_string_t *str = iodef_value_get_string(input);

                ret = iodef_data_new_char_string_dup_fast(&data, prelude_string_get_string(str), prelude_string_get_len(str));
                if ( ret < 0 )
                        return ret;
...
static int cast_to_time(iodef_value_t *value)
{
        ...
        if ( iodef_value_get_type(value) == IODEF_VALUE_TYPE_STRING ) {
                ret = iodef_time_new_from_string(&time, prelude_string_get_string(iodef_value_get_string(value)));
                if ( ret < 0 )
                        return ret;
...
static int cast_from_string(iodef_value_t *value, iodef_value_type_id_t ntype)
{
        ...
        ret = iodef_value_type_read(&vt, prelude_string_get_string(str));
        if ( ret < 0 )
                return ret;
...
int _iodef_value_cast(iodef_value_t *value, iodef_value_type_id_t ntype, iodef_class_id_t id)
{
        ...
        if ( ntype == IODEF_VALUE_TYPE_DATA )
                ...
                prelude_string_t *str = iodef_value_get_string(value);
                return iodef_value_set_enum_from_string(value, id, prelude_string_get_string(str));
        }
