...
static uint64_t get_current_time(libiodef_ident_t *ident)
{
        uint64_t now;
...
static void uuidgen(libiodef_ident_t *ident)
{
        uint64_t timestamp;
 ...
 *
 * Create a new #libiodef_ident_t object with an unique value.
 *
 * Returns: 0 on success, or a negative value if an error occured.
 */
int libiodef_ident_new(libiodef_ident_t **ret)
{
        libiodef_ident_t *new;
...
/**
 * libiodef_ident_generate:
 * @ident: Pointer to a #libiodef_ident_t object.
 * @out: #libiodef_string_t where the ident will be generated.
 *
...
int libiodef_ident_generate(libiodef_ident_t *ident, libiodef_string_t *out)
{
        ...
        return libiodef_string_sprintf(out, "%8.8x-%4.4x-%4.4x-%2.2x%2.2x",
...
/**
 * libiodef_ident_destroy:
 * @ident: Pointer to a #libiodef_ident_t object.
 *
 * Destroy a #libiodef_ident_t object.
 */
