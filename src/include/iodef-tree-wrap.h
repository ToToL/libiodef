...
#ifndef _LIBPRELUDE_IODEF_TREE_WRAP_H
#define _LIBPRELUDE_IODEF_TREE_WRAP_H
...
prelude_string_t *iodef_additional_data_get_formatid(iodef_additional_data_t *ptr);
void iodef_additional_data_set_formatid(iodef_additional_data_t *ptr, prelude_string_t *formatid);
int iodef_additional_data_new_formatid(iodef_additional_data_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_additional_data_get_meaning(iodef_additional_data_t *ptr);
void iodef_additional_data_set_meaning(iodef_additional_data_t *ptr, prelude_string_t *meaning);
int iodef_additional_data_new_meaning(iodef_additional_data_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_additional_data_get_ext_dtype(iodef_additional_data_t *ptr);
void iodef_additional_data_set_ext_dtype(iodef_additional_data_t *ptr, prelude_string_t *ext_dtype);
int iodef_additional_data_new_ext_dtype(iodef_additional_data_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_email_get_email(iodef_email_t *ptr);
void iodef_email_set_email(iodef_email_t *ptr, prelude_string_t *email);
int iodef_email_new_email(iodef_email_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_registry_handle_get_ext_registry(iodef_registry_handle_t *ptr);
void iodef_registry_handle_set_ext_registry(iodef_registry_handle_t *ptr, prelude_string_t *ext_registry);
int iodef_registry_handle_new_ext_registry(iodef_registry_handle_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_contact_get_fax(iodef_contact_t *ptr);
void iodef_contact_set_fax(iodef_contact_t *ptr, prelude_string_t *fax);
int iodef_contact_new_fax(iodef_contact_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_contact_get_next_description(iodef_contact_t *contact, prelude_string_t *prelude_string_cur);
void iodef_contact_set_description(iodef_contact_t *ptr, prelude_string_t *object, int pos);
int iodef_contact_new_description(iodef_contact_t *ptr, prelude_string_t **ret, int pos);

prelude_string_t *iodef_contact_get_next_telephone(iodef_contact_t *contact, prelude_string_t *prelude_string_cur);
void iodef_contact_set_telephone(iodef_contact_t *ptr, prelude_string_t *object, int pos);
int iodef_contact_new_telephone(iodef_contact_t *ptr, prelude_string_t **ret, int pos);
...
prelude_string_t *iodef_contact_get_contact_name(iodef_contact_t *ptr);
void iodef_contact_set_contact_name(iodef_contact_t *ptr, prelude_string_t *contact_name);
int iodef_contact_new_contact_name(iodef_contact_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_contact_get_timezone(iodef_contact_t *ptr);
void iodef_contact_set_timezone(iodef_contact_t *ptr, prelude_string_t *timezone);
int iodef_contact_new_timezone(iodef_contact_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_contact_get_ext_type(iodef_contact_t *ptr);
void iodef_contact_set_ext_type(iodef_contact_t *ptr, prelude_string_t *ext_type);
int iodef_contact_new_ext_type(iodef_contact_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_contact_get_ext_role(iodef_contact_t *ptr);
void iodef_contact_set_ext_role(iodef_contact_t *ptr, prelude_string_t *ext_role);
int iodef_contact_new_ext_role(iodef_contact_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_incident_id_get_instance(iodef_incident_id_t *ptr);
void iodef_incident_id_set_instance(iodef_incident_id_t *ptr, prelude_string_t *instance);
int iodef_incident_id_new_instance(iodef_incident_id_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_incident_id_get_name(iodef_incident_id_t *ptr);
void iodef_incident_id_set_name(iodef_incident_id_t *ptr, prelude_string_t *name);
int iodef_incident_id_new_name(iodef_incident_id_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_related_activity_get_next_url(iodef_related_activity_t *related_activity, prelude_string_t *prelude_string_cur);
void iodef_related_activity_set_url(iodef_related_activity_t *ptr, prelude_string_t *object, int pos);
int iodef_related_activity_new_url(iodef_related_activity_t *ptr, prelude_string_t **ret, int pos);
...
prelude_string_t *iodef_history_item_get_next_description(iodef_history_item_t *history_item, prelude_string_t *prelude_string_cur);
void iodef_history_item_set_description(iodef_history_item_t *ptr, prelude_string_t *object, int pos);
int iodef_history_item_new_description(iodef_history_item_t *ptr, prelude_string_t **ret, int pos);
...
prelude_string_t *iodef_history_item_get_ext_action(iodef_history_item_t *ptr);
void iodef_history_item_set_ext_action(iodef_history_item_t *ptr, prelude_string_t *ext_action);
int iodef_history_item_new_ext_action(iodef_history_item_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_expectation_get_next_description(iodef_expectation_t *expectation, prelude_string_t *prelude_string_cur);
void iodef_expectation_set_description(iodef_expectation_t *ptr, prelude_string_t *object, int pos);
int iodef_expectation_new_description(iodef_expectation_t *ptr, prelude_string_t **ret, int pos);
...
prelude_string_t *iodef_expectation_get_ext_action(iodef_expectation_t *ptr);
void iodef_expectation_set_ext_action(iodef_expectation_t *ptr, prelude_string_t *ext_action);
int iodef_expectation_new_ext_action(iodef_expectation_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_record_pattern_get_ext_type(iodef_record_pattern_t *ptr);
void iodef_record_pattern_set_ext_type(iodef_record_pattern_t *ptr, prelude_string_t *ext_type);
int iodef_record_pattern_new_ext_type(iodef_record_pattern_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_record_pattern_get_ext_offsetunit(iodef_record_pattern_t *ptr);
void iodef_record_pattern_set_ext_offsetunit(iodef_record_pattern_t *ptr, prelude_string_t *ext_offsetunit);
int iodef_record_pattern_new_ext_offsetunit(iodef_record_pattern_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_record_item_get_formatid(iodef_record_item_t *ptr);
void iodef_record_item_set_formatid(iodef_record_item_t *ptr, prelude_string_t *formatid);
int iodef_record_item_new_formatid(iodef_record_item_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_record_item_get_meaning(iodef_record_item_t *ptr);
void iodef_record_item_set_meaning(iodef_record_item_t *ptr, prelude_string_t *meaning);
int iodef_record_item_new_meaning(iodef_record_item_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_record_item_get_ext_dtype(iodef_record_item_t *ptr);
void iodef_record_item_set_ext_dtype(iodef_record_item_t *ptr, prelude_string_t *ext_dtype);
int iodef_record_item_new_ext_dtype(iodef_record_item_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_application_get_url(iodef_application_t *ptr);
void iodef_application_set_url(iodef_application_t *ptr, prelude_string_t *url);
int iodef_application_new_url(iodef_application_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_application_get_vendor(iodef_application_t *ptr);
void iodef_application_set_vendor(iodef_application_t *ptr, prelude_string_t *vendor);
int iodef_application_new_vendor(iodef_application_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_application_get_name(iodef_application_t *ptr);
void iodef_application_set_name(iodef_application_t *ptr, prelude_string_t *name);
int iodef_application_new_name(iodef_application_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_application_get_family(iodef_application_t *ptr);
void iodef_application_set_family(iodef_application_t *ptr, prelude_string_t *family);
int iodef_application_new_family(iodef_application_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_application_get_swid(iodef_application_t *ptr);
void iodef_application_set_swid(iodef_application_t *ptr, prelude_string_t *swid);
int iodef_application_new_swid(iodef_application_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_application_get_patch(iodef_application_t *ptr);
void iodef_application_set_patch(iodef_application_t *ptr, prelude_string_t *patch);
int iodef_application_new_patch(iodef_application_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_application_get_version(iodef_application_t *ptr);
void iodef_application_set_version(iodef_application_t *ptr, prelude_string_t *version);
int iodef_application_new_version(iodef_application_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_application_get_configid(iodef_application_t *ptr);
void iodef_application_set_configid(iodef_application_t *ptr, prelude_string_t *configid);
int iodef_application_new_configid(iodef_application_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_record_data_get_next_description(iodef_record_data_t *record_data, prelude_string_t *prelude_string_cur);
void iodef_record_data_set_description(iodef_record_data_t *ptr, prelude_string_t *object, int pos);
int iodef_record_data_new_description(iodef_record_data_t *ptr, prelude_string_t **ret, int pos);
...
prelude_string_t *iodef_reference_get_next_url(iodef_reference_t *reference, prelude_string_t *prelude_string_cur);
void iodef_reference_set_url(iodef_reference_t *ptr, prelude_string_t *object, int pos);
int iodef_reference_new_url(iodef_reference_t *ptr, prelude_string_t **ret, int pos);

prelude_string_t *iodef_reference_get_next_description(iodef_reference_t *reference, prelude_string_t *prelude_string_cur);
void iodef_reference_set_description(iodef_reference_t *ptr, prelude_string_t *object, int pos);
int iodef_reference_new_description(iodef_reference_t *ptr, prelude_string_t **ret, int pos);

prelude_string_t *iodef_reference_get_reference_name(iodef_reference_t *ptr);
void iodef_reference_set_reference_name(iodef_reference_t *ptr, prelude_string_t *reference_name);
int iodef_reference_new_reference_name(iodef_reference_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_method_get_next_description(iodef_method_t *method, prelude_string_t *prelude_string_cur);
void iodef_method_set_description(iodef_method_t *ptr, prelude_string_t *object, int pos);
int iodef_method_new_description(iodef_method_t *ptr, prelude_string_t **ret, int pos);
...
prelude_string_t *iodef_time_impact_get_ext_metric(iodef_time_impact_t *ptr);
void iodef_time_impact_set_ext_metric(iodef_time_impact_t *ptr, prelude_string_t *ext_metric);
int iodef_time_impact_new_ext_metric(iodef_time_impact_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_time_impact_get_ext_duration(iodef_time_impact_t *ptr);
void iodef_time_impact_set_ext_duration(iodef_time_impact_t *ptr, prelude_string_t *ext_duration);
int iodef_time_impact_new_ext_duration(iodef_time_impact_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_impact_get_ext_type(iodef_impact_t *ptr);
void iodef_impact_set_ext_type(iodef_impact_t *ptr, prelude_string_t *ext_type);
int iodef_impact_new_ext_type(iodef_impact_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_monetary_impact_get_currency(iodef_monetary_impact_t *ptr);
void iodef_monetary_impact_set_currency(iodef_monetary_impact_t *ptr, prelude_string_t *currency);
int iodef_monetary_impact_new_currency(iodef_monetary_impact_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_counter_get_ext_duration(iodef_counter_t *ptr);
void iodef_counter_set_ext_duration(iodef_counter_t *ptr, prelude_string_t *ext_duration);
int iodef_counter_new_ext_duration(iodef_counter_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_counter_get_ext_type(iodef_counter_t *ptr);
void iodef_counter_set_ext_type(iodef_counter_t *ptr, prelude_string_t *ext_type);
int iodef_counter_new_ext_type(iodef_counter_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_service_get_portlist(iodef_service_t *ptr);
void iodef_service_set_portlist(iodef_service_t *ptr, prelude_string_t *portlist);
int iodef_service_new_portlist(iodef_service_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_address_get_vlan_name(iodef_address_t *ptr);
void iodef_address_set_vlan_name(iodef_address_t *ptr, prelude_string_t *vlan_name);
int iodef_address_new_vlan_name(iodef_address_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_address_get_ext_category(iodef_address_t *ptr);
void iodef_address_set_ext_category(iodef_address_t *ptr, prelude_string_t *ext_category);
int iodef_address_new_ext_category(iodef_address_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_address_get_vlan_num(iodef_address_t *ptr);
void iodef_address_set_vlan_num(iodef_address_t *ptr, prelude_string_t *vlan_num);
int iodef_address_new_vlan_num(iodef_address_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_node_role_get_ext_category(iodef_node_role_t *ptr);
void iodef_node_role_set_ext_category(iodef_node_role_t *ptr, prelude_string_t *ext_category);
int iodef_node_role_new_ext_category(iodef_node_role_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_node_get_next_node_name(iodef_node_t *node, prelude_string_t *prelude_string_cur);
void iodef_node_set_node_name(iodef_node_t *ptr, prelude_string_t *object, int pos);
int iodef_node_new_node_name(iodef_node_t *ptr, prelude_string_t **ret, int pos);
...
prelude_string_t *iodef_node_get_location(iodef_node_t *ptr);
void iodef_node_set_location(iodef_node_t *ptr, prelude_string_t *location);
int iodef_node_new_location(iodef_node_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_operating_system_get_url(iodef_operating_system_t *ptr);
void iodef_operating_system_set_url(iodef_operating_system_t *ptr, prelude_string_t *url);
int iodef_operating_system_new_url(iodef_operating_system_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_operating_system_get_vendor(iodef_operating_system_t *ptr);
void iodef_operating_system_set_vendor(iodef_operating_system_t *ptr, prelude_string_t *vendor);
int iodef_operating_system_new_vendor(iodef_operating_system_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_operating_system_get_name(iodef_operating_system_t *ptr);
void iodef_operating_system_set_name(iodef_operating_system_t *ptr, prelude_string_t *name);
int iodef_operating_system_new_name(iodef_operating_system_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_operating_system_get_family(iodef_operating_system_t *ptr);
void iodef_operating_system_set_family(iodef_operating_system_t *ptr, prelude_string_t *family);
int iodef_operating_system_new_family(iodef_operating_system_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_operating_system_get_swid(iodef_operating_system_t *ptr);
void iodef_operating_system_set_swid(iodef_operating_system_t *ptr, prelude_string_t *swid);
int iodef_operating_system_new_swid(iodef_operating_system_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_operating_system_get_patch(iodef_operating_system_t *ptr);
void iodef_operating_system_set_patch(iodef_operating_system_t *ptr, prelude_string_t *patch);
int iodef_operating_system_new_patch(iodef_operating_system_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_operating_system_get_version(iodef_operating_system_t *ptr);
void iodef_operating_system_set_version(iodef_operating_system_t *ptr, prelude_string_t *version);
int iodef_operating_system_new_version(iodef_operating_system_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_operating_system_get_configid(iodef_operating_system_t *ptr);
void iodef_operating_system_set_configid(iodef_operating_system_t *ptr, prelude_string_t *configid);
int iodef_operating_system_new_configid(iodef_operating_system_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_system_get_next_description(iodef_system_t *system, prelude_string_t *prelude_string_cur);
void iodef_system_set_description(iodef_system_t *ptr, prelude_string_t *object, int pos);
int iodef_system_new_description(iodef_system_t *ptr, prelude_string_t **ret, int pos);
...
prelude_string_t *iodef_system_get_ext_category(iodef_system_t *ptr);
void iodef_system_set_ext_category(iodef_system_t *ptr, prelude_string_t *ext_category);
int iodef_system_new_ext_category(iodef_system_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_system_get_interface(iodef_system_t *ptr);
void iodef_system_set_interface(iodef_system_t *ptr, prelude_string_t *interface);
int iodef_system_new_interface(iodef_system_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_event_data_get_next_description(iodef_event_data_t *event_data, prelude_string_t *prelude_string_cur);
void iodef_event_data_set_description(iodef_event_data_t *ptr, prelude_string_t *object, int pos);
int iodef_event_data_new_description(iodef_event_data_t *ptr, prelude_string_t **ret, int pos);
...
prelude_string_t *iodef_incident_get_next_description(iodef_incident_t *incident, prelude_string_t *prelude_string_cur);
void iodef_incident_set_description(iodef_incident_t *ptr, prelude_string_t *object, int pos);
int iodef_incident_new_description(iodef_incident_t *ptr, prelude_string_t **ret, int pos);
...
prelude_string_t *iodef_incident_get_ext_purpose(iodef_incident_t *ptr);
void iodef_incident_set_ext_purpose(iodef_incident_t *ptr, prelude_string_t *ext_purpose);
int iodef_incident_new_ext_purpose(iodef_incident_t *ptr, prelude_string_t **ret);
...
prelude_string_t *iodef_document_get_formatid(iodef_document_t *ptr);
void iodef_document_set_formatid(iodef_document_t *ptr, prelude_string_t *formatid);
int iodef_document_new_formatid(iodef_document_t *ptr, prelude_string_t **ret);

prelude_string_t *iodef_document_get_version(iodef_document_t *ptr);
void iodef_document_set_version(iodef_document_t *ptr, prelude_string_t *version);
int iodef_document_new_version(iodef_document_t *ptr, prelude_string_t **ret);
...
#endif /* _LIBPRELUDE_IODEF_TREE_WRAP */
