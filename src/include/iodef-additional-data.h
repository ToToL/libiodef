...
#ifndef _LIBPRELUDE_IODEF_ADDITIONAL_DATA_H
#define _LIBPRELUDE_IODEF_ADDITIONAL_DATA_H
...
int iodef_additional_data_new_boolean(iodef_additional_data_t **ret, prelude_bool_t data);
...
void iodef_additional_data_set_boolean(iodef_additional_data_t *ptr, prelude_bool_t data);
...
prelude_bool_t iodef_additional_data_get_boolean(iodef_additional_data_t *data);
